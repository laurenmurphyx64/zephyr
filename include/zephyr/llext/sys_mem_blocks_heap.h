...
/**
 * @brief Implementation of @ref llext_heap that uses a sys_mem_blocks heap
 */
...
extern struct llext_sys_mem_blocks_heap llext_sys_mem_blocks_heap;
extern struct llext_heap *llext_heap;
/** @endcond */
