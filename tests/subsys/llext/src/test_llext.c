...
static void *ztest_suite_setup(void)
{
#ifdef CONFIG_LLEXT_HEAP_DYNAMIC
#ifdef CONFIG_HARVARD
	zassert_ok(llext_heap_init_harvard(llext_heap, llext_instr_heap_data,
	...
	zassert_ok(llext_heap_init(llext_heap, llext_heap_data, sizeof(llext_heap_data)));
...
#ifdef CONFIG_LLEXT_HEAP_DYNAMIC
	zassert_ok(llext_heap_uninit(llext_heap));
#endif
}
