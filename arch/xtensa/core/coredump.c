...
enum xtensa_soc_code {
	...
	XTENSA_SOC_ESP32,
	XTENSA_SOC_INTEL_ADSP_CAVS15,
	XTENSA_SOC_INTEL_ADSP_CAVS18,
	XTENSA_SOC_INTEL_ADSP_CAVS20,
	XTENSA_SOC_INTEL_ADSP_CAVS25,
};
...
#elif CONFIG_SOC_SERIES_INTEL_CAVS_V15
	arch_blk.soc = XTENSA_SOC_INTEL_ADSP_CAVS15;
#elif CONFIG_SOC_SERIES_INTEL_CAVS_V18
	arch_blk.soc = XTENSA_SOC_INTEL_ADSP_CAVS18;
#elif CONFIG_SOC_SERIES_INTEL_CAVS_V20
	arch_blk.soc = XTENSA_SOC_INTEL_ADSP_CAVS20;
#elif CONFIG_SOC_SERIES_INTEL_CAVS_V25
	arch_blk.soc = XTENSA_SOC_INTEL_ADSP_CAVS25;
#else
